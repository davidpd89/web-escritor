...
const mismatch = rich.replace('978-1-23456-789-7', '978-9-87654-321-0');
const b = auditBookPageHtml(mismatch);
assert.equal(b.findings.consistency.some(x => x.id === 'book_isbn_mismatch'), true);
