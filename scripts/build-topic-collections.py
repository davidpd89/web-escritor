...
def head(title: str, description: str, canonical: str, jsonld: dict) -> str:
    ...
    return (
        ...
        '<link rel="preload" as="style" href="/assets/v1-editorial-placeholders-v4.css?v=1">'
        '<link rel="preload" as="style" href="/assets/v1-editorial-interactions-v4.css?v=1">'
        '<link rel="preload" as="style" href="/assets/v1-banner-art-direction-v5.css?v=1">'
