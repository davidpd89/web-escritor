...
<head>
    ...
    <link rel="preload" as="style" href="/assets/v1-shell-base.css?v=2" />
...
{main_html}
    ...
    <script defer src="/assets/v1-shell.js?v=13"></script>
    {script}
</body>
</html>
'''
...
<main id="contenido" tabindex="-1" class="v1-main" data-family="tool">
  {breadcrumbs([('Inicio', '/'), ('Editoriales', '/editoriales/'), ('Metodología', None)])}
    ...
    <section class="v1-section">
        ...
        <div class="tool-findings-block"><h2>Correcciones</h2><p>Si eres responsable de una editorial listada o detectas un dato incorrecto u obsoleto, escribe indicando la ficha y la fuente oficial: <a href="/prensa.html#contacto" data-email-reveal>Contactar por email</a>. Las correcciones con fuente se aplican y quedan reflejadas en el historial de comprobaciones de la ficha correspondiente.</p></div>
