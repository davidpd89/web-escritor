...
need('SESSION_RATE_LIMITER' in worker and 'IP_RATE_LIMITER' in worker and 'GLOBAL_RATE_LIMITER' in worker, "three anti-abuse rate-limit bindings are required")
...
if errors:
    ...
    sys.exit(1)
print(f"Assistant contract OK: {len(ids)} public sources, protocol v1, fail-closed Worker, Turnstile and safe URL contract.")
